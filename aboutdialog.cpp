...
QString head=QString::fromUtf8("<b>Texmaker (Fork) ")+QLatin1String(VERSION)+QString::fromUtf8(" by Leonid Kostrykin</b><br>(compiled with Qt ")+QLatin1String(QT_VERSION_STR);
#if !defined(OLDPOPPLER)
head+=QString::fromUtf8(" and Poppler ")+QLatin1String(POPPLER_VERSION);
#endif
ui.textBrowser1->setHtml(head+QString::fromUtf8(")<br><br>Based on <b>Texmaker ")+QLatin1String(TEXMAKERVERSION)+QString::fromUtf8("</b><br><b>Copyright (c) 2003-2015 by Pascal Brachet</b><br><br>Project home site : <a href=\"http://www.xm1math.net/texmaker/\">http://www.xm1math.net/texmaker/</a>"));
